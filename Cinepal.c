        ...
        do
        {
            ...
            if (unum == 1 || unum == 2 || unum == 3)
            {
                ...
                if (pw[unum - 1][10] == upw[0])
                {
                    ...
                    found = 1;
                    printf("\nWelcome to CinePal - Your all in-one-ticket to cinemetropolis!");
...
void help(int unum)
{
    ...
    if (ans2 == 1)
    {
        ...
        if (ans3 == 1)
        {
            printf("\nDevelopers' Phone number: 1111122222\nDevelopers' Email ID: cinepal@gmail.com");
...
void recommend(int unum, char movie[17][50], char desc[17][1000], double cine[17])
{
    ...
    do
    {
        printf("\nWould you like CinePal to recommend a movie for you?\nEnter 1 for receiving a random movie recommendation.\nEnter 2 for receiving movie recommendations based on their CinePal rating\nEnter number: ");
        scanf("%d", &recom);
        srand(time(0));
        if (recom == 1)
        {
